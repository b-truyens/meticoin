Contributing to Meticoin Core
============================

The Meticoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Meticoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/meticoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to meticoin-qt
...
The following applies to code changes to the Meticoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Meticoin
Network Protocol consensus changes.

Whether a pull request is merged into Meticoin Core rests with the project merge
...
Patches that change Meticoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Meticoin consensus, it must have been
...
The project leader is the release manager for each Meticoin Core release.
