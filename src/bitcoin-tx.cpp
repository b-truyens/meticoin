...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " meticoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  meticoin-tx [options] <hex-tx> [commands]  Update hex-encoded meticoin transaction\n" +
            "or:     meticoin-tx [options] -create [commands]   Create hex-encoded meticoin transaction\n" +
            "\n";
