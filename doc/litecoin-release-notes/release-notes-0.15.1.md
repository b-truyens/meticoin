Meticoin Core version *0.15.1* is now available from:

  <https://download.meticoin.org/meticoin-0.15.1/>
...
A number of changes to the way Meticoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 stuivers per kB (0.00001 METI). This is to prepare for dropping the minimum transaction fee to 0.1 stuivers per kB (0.0001 METI) in the next release.
