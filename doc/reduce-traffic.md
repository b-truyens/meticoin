...
By default, Meticoin Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that meticoin's trustless model works best if you are
