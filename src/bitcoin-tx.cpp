...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s meticoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  meticoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded meticoin transaction") + "\n" +
              "  meticoin-tx [options] -create [commands]   " + _("Create hex-encoded meticoin transaction") + "\n" +
              "\n";
