# Support for Output Descriptors in Meticoin Core

Since Meticoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Meticoin Core wallets, a convenience function `combo` is
