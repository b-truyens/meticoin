...
#if defined(NDEBUG)
# error "Meticoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Meticoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s METI additional fees, %d delta bytes\n",
