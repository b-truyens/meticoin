...
{
    const char* pszTimestamp = "jul 31 2023 23:29";
    const CScript genesisOutputScript = CScript() << ParseHex("0449438646bc413677af793376a6d5851ba34812ccac85990fdad6749e5facb3da2727ddd17c1f178974ace745f714474d4c291591be069418f7602e0bbda0fdaa") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1690838942, 1998774, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("1bbee43a83eb5621e0b6a48cac5627a90561c3b8ed9cc1b9e1b4e67d9d9c8525"));
        ...
        // vSeeds.emplace_back("seed-a.meticoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.meticointools.com");
        // vSeeds.emplace_back("dnsseed.meticoinpool.org");
        ...
        checkpointData = {
            {
                {0, uint256S("1bbee43a83eb5621e0b6a48cac5627a90561c3b8ed9cc1b9e1b4e67d9d9c8525")},
            }
        };
