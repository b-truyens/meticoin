...
1. Clone the Meticoin Core source code:
    ```shell
...
2.  Build Meticoin Core:
    ...
    Configure and build the headless Meticoin Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Meticoin Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Meticoin"

touch "/Users/${USER}/Library/Application Support/Meticoin/meticoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Meticoin/meticoin.conf"
```

The first time you run meticoind, it will start downloading the blockchain. This process could
