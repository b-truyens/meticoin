...
const char * const BITCOIN_CONF_FILENAME = "meticoin.conf";
const char * const BITCOIN_PID_FILENAME = "meticoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Meticoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Meticoin";
#else
    // Unix
    return pathRet / ".meticoin";
#endif
#endif
}
