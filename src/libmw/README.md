...
Modular library for supporting Meticoin's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by meticoin or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by meticoin, I was uncomfortable with its API and its handling of unicode conversions.
...
and just replace the more-limited secp256k1 dependency that's already included in Meticoin.
