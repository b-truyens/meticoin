This directory contains the MeticoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Meticoin UI.
...
Used to process BIP21 payment URI requests. Also handles URI based application switching (e.g. when following a meticoin:... link from a browser).
...
10. Start debugging with Qt Creator (you might need to the executable to "meticoin-qt" under "Run", which is where you can also add command line arguments)
