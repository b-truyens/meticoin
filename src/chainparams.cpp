...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.meticoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.meticointools.com", true);
        vSeeds.emplace_back("dnsseed.meticoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.meticointools.com", true);
        vSeeds.emplace_back("seed-b.meticoin.loshan.co.uk", true);
