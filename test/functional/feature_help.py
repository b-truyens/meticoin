...
"""Verify that starting meticoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start meticoin with -h for help text")
        ...
        self.log.info("Start meticoin with -version for version information")
        ...
        self.log.info("Start meticoind with -fakearg to make sure it does not start")
